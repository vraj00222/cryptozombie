...
2. MORE JS FUNCTIONALITY (Suggestion #3)
...
3. KITTY SMART CONTRACT ADDED TO BACKEND (Suggestion #4)
...
4. ZOMBIE IMAGES FROM DNA (Suggestion #5)
...
5. ZOMBIE ARMY / MULTIPLE ZOMBIES (Suggestion #6)
...
6. NO HARD-CODED VALUES (Suggestion #9)
